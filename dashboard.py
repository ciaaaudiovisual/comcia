...
# --- FUNÇÃO DO LEITOR DE CÓDIGO DE BARRAS (ADICIONADA DE VOLTA) ---
...
def show_dashboard():
    ...
    # --- VARIÁVEIS DE SESSÃO DO SCANNER (ADICIONADAS DE VOLTA) ---
    ...
    # --- SEÇÃO DE ANOTAÇÃO EM MASSA (ADICIONADA DE VOLTA) ---
